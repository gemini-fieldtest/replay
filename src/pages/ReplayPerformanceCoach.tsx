...
interface ReplayPerformanceCoachProps {
...
export const ReplayPerformanceCoach: React.FC<ReplayPerformanceCoachProps> = ({ currentFrame, ghostFrame, currentIndex, laps }) => {
